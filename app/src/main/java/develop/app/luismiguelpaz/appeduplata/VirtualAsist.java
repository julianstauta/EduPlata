...
public class VirtualAsist extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_virtual_asist);
  ...
  private void sendMessage() {
    ...
    if (!this.initialRequest) {
      ...
      Toast.makeText(getApplicationContext(), "Presiona el micrófono para grabar tu mensaje", Toast.LENGTH_LONG).show();
  ...
  private void recordMessage() {
    if (listening != true) {
      ...
      listening = true;
      Toast.makeText(VirtualAsist.this, "Escuchando....presiona para detener", Toast.LENGTH_LONG).show();

    } else {
      try {
        microphoneHelper.closeInputStream();
        listening = false;
        Toast.makeText(VirtualAsist.this, "presiona para grabar otra vez", Toast.LENGTH_LONG).show();
      } catch (Exception e) {
        e.printStackTrace();
      }
  ...
  private void showError(final Exception e) {
    runOnUiThread(new Runnable() {
      @Override
      public void run() {
        Toast.makeText(VirtualAsist.this, e.getMessage(), Toast.LENGTH_SHORT).show();
        e.printStackTrace();
      }
    });
  }
